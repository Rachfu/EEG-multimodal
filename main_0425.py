...
def pretrain():
    ...
    os.makedirs('model_dict/PriConcat/pretrain', exist_ok=True)
    ...
    whole_record_path = 'model_dict/PriConcat/pretrain/whole_record.txt'
    best_record_path = 'model_dict/PriConcat/pretrain/best_record.txt'
    save_model_path = 'model_dict/PriConcat/pretrain/best_f1.pickle'
