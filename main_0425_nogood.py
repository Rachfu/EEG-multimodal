...
class ConcatModel(nn.Module):
    def __init__(self):
        ...
        #     nn.Linear(3*768, 6*768),
        #     nn.ReLU(),
        #     nn.Linear(6*768, 6*768),
        #     nn.ReLU(),
        #     nn.Linear(6*768, 6*768),
        #     nn.ReLU(),
        #     nn.Linear(6*768, 768),
...
if __name__ == '__main__':
    ...
    new_path = '3'
    os.makedirs('model_dict/ConcatModel_v{:}'.format(new_path), exist_ok=True)
    
    # save_model_path = 'model_dict/ConcatModel/best_f1.pickle'
    # record_path = 'model_dict/ConcatModel/record.txt'
    load_model_path = 'model_dict/ConcatModel/best_f1.pickle'
    whole_record_path = 'model_dict/ConcatModel_v{:}/whole_record.txt'.format(new_path)
    best_record_path = 'model_dict/ConcatModel_v{:}/best_record.txt'.format(new_path)
    save_model_path = 'model_dict/ConcatModel_v{:}/best_f1.pickle'.format(new_path)
